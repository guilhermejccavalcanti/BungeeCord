...
public class PacketDefinitions {
    ...
    static {
        ...
        opCodes[0x64] = new OpCode[] { BYTE, BYTE, STRING, BYTE, BOOLEAN };
        ...
        opCodes[0xCE] = new OpCode[] { STRING, STRING, BYTE };
        opCodes[0xCF] = new OpCode[] { STRING, BYTE, STRING, INT };
        opCodes[0xD0] = new OpCode[] { BYTE, STRING };
        opCodes[0xD1] = new OpCode[] { TEAM };
        ...
        /*========================== Minecraft Forge ===========================*/
        opCodes[0x01 + FORGE_PROTOCOL] = new OpCode[] { INT, STRING, BYTE, INT, BYTE, BYTE, BYTE };
    }
